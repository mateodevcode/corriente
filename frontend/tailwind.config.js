/**
 * tailwind.config.js del frontend público — COPIA CONTROLADA del sistema de diseño
 * compartido en la raíz del proyecto (../tailwind.config.js).
 *
 * FUENTE ÚLTIMA: raíz del proyecto. Todos los tokens vienen del prototipo
 * "corriente diseño/" (oklch de app/globals.css convertidos a hex).
 * Cualquier cambio se hace en la raíz y se replica aquí (misma gestión que en admin/).
 */

/** @type {import('tailwindcss').Config} */
module.exports = {
  content: [
    './src/**/*.{js,jsx,astro,html}',
  ],
  darkMode: 'class',
  theme: {
    extend: {
