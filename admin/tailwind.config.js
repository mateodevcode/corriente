 ...
 *
 * COPIA CONTROLADA del sistema de diseño compartido (raíz del proyecto).
 * Cambia la raíz y replica aquí (misma gestión que en frontend/).
 * Originalmente reutilizado por:
